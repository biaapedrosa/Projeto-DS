// Link: componente do React Router para navegação interna sem recarregar a página
import { Link } from 'react-router-dom';

// Importa o CSS específico do Footer
import './Footer.css';
  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        ...
        {/* Coluna 1: logo e descrição da plataforma */}
        <div className="footer-brand">
          <div className="footer-logo">
            {/* Mesmo SVG da NavBar — ícone de folha da marca NutriFlow */}
        ...
        {/* Coluna 2: links de navegação rápida para as principais seções */}
        ...
        {/* Coluna 3: informações de contato da clínica */}
